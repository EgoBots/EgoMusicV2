...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("/tagall  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴀssᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ ")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        return await message.reply("/tagall  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴀssɢᴀᴇ ɴᴇxᴛ ᴛɪᴍᴇ ..")
...
async def cancel_spam(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴅᴍɪɴ ʙᴀʙʏ, ᴏɴʟʏ ᴀᴅᴍɪɴs ᴄᴀɴ ᴛᴀɢ ᴍᴀᴍʙᴇʀs.")
    else:
        try:
