...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("/shayaril  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴀssᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ ")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
        ...
        if not msg:
            return await message.reply("/shayari  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴀssᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ ...")
    else:
        return await message.reply("/shayari  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪs / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴀssᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ ..")
    if chat_id in spam_chats:
        return await message.reply("ᴘʟᴇᴀss ᴀᴛ ғɪʀsʀ sᴛᴏᴘ ʀᴜɴɴɪɴɢ ᴘʀᴏᴄᴇss ...")
